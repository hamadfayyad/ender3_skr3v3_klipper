...
IO.setup(21,IO.OUT)            # Initialize GPIO14 as our fan output pin
fan = IO.PWM(21,100)           # Set GPIO14 as a PWM output, with 100Hz frequency (this should match your fans specified PWM frequency)
fan.start(0)                   # Generate a PWM signal with a 0% duty cycle (fan off)

minTemp = 51                   # Temperature and speed range variables, edit these to adjust max and min temperatures and speeds
maxTemp = 80
minSpeed = 60
maxSpeed = 100
